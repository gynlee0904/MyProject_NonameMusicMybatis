...
<!-- 							</tr> -->
					...
					<div id="table_footer">
                        ...
                        <div id="btn">
                            <button type="button" name ="uploadBtn" id="uploadBtn" onclick="location.href='/board/insert.do?'">글작성</button>
                            <button type="button" name ="listBtn" id="listBtn" onclick="location.href='/board/list.do?currentPage=1'">첫페이지로</button></a>
